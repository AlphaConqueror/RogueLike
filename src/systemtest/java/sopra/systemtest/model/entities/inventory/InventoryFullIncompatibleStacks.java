...
public class InventoryFullIncompatibleStacks extends SystemTest {
  public InventoryFullIncompatibleStacks() {
    super(InventoryFullIncompatibleStacks.class, false);
  }
  ...
  protected void run() throws TimeoutException, AssertionError {
    ...
    // try to pick up a potion with a different level
    sendPickUp(Direction.NORTH_EAST);
    // should fail
    assertCommandFailed();
    assertNextCycle(count);
    assertActNow();
    // check that the inventory is still correct
    sendInventory();
    assertChoiceWindow("{\"listType\":\"items\",\"items\":["
            + "{\"potion\":{\"stackSize\":1,\"level\":1,\"name\":\"potion\",\"value\":5},"
            + "\"objectType\":\"potion\"},{\"weapon\":{\"damage\":1,\"level\":1,"
            + "\"name\":\"Sword\",\"range\":1},\"objectType\":\"weapon\"},"
            + "{\"weapon\":{\"damage\":1,\"level\":1,\"name\":\"Sword\",\"range\":1},"
            + "\"objectType\":\"weapon\"},{\"weapon\":{\"damage\":1,\"level\":1,"
            + "\"name\":\"Sword\",\"range\":1},\"objectType\":\"weapon\"},"
            + "{\"weapon\":{\"damage\":1,\"level\":1,\"name\":\"Sword\","
            + "\"range\":1},\"objectType\":\"weapon\"},{\"weapon\":"
            + "{\"damage\":1,\"level\":1,\"name\":\"Sword\",\"range\":1},"
            + "\"objectType\":\"weapon\"},{\"weapon\":"
            + "{\"damage\":1,\"level\":1,\"name\":\"Sword\",\"range\":1},"
            + "\"objectType\":\"weapon\"},{\"weapon\":{\"damage\":1,"
            + "\"level\":1,\"name\":\"Sword\",\"range\":1},"
            + "\"objectType\":\"weapon\"},{\"weapon\":"
