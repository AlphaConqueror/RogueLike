...
public class PickupButAttacked extends SystemTest {
  public PickupButAttacked() {
  ...
  public String createWorld() {
    return loadResource(this.getClass(), "maps/itemTestMaps/ItemsAndMonster.json");
  }
