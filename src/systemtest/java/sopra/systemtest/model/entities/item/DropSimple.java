...
public class DropSimple extends SystemTest {
  public DropSimple() {
    super(DropSimple.class, false);
  }
  ...
  public void run() throws TimeoutException {
    ...
    assertChoiceWindow("{\"listType\":\"items\",\"items\":["
            ...
            + "\"objectType\":\"decoction\"},{\"objectType\":\"empty\"},"
            + "{\"weapon\":{\"damage\":2,\"level\":2,\"name\":\"Laserknarre\","
            + "\"range\":2},\"objectType\":\"weapon\"},{\"swordPart\":"
            + "{\"stackSize\":1},\"objectType\":\"swordPart\"},"
