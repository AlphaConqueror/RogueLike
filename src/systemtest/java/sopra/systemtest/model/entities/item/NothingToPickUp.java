...
public class NothingToPickUp extends SystemTest {
  public NothingToPickUp() {
    super(NothingToPickUp.class, false);
  }
  ...
  public void run() throws TimeoutException {
    ...
    //expect no update world since nothing changed - nothing else should happen
    assertNextCycle(1);
    assertActNow();
    sendInventory();
