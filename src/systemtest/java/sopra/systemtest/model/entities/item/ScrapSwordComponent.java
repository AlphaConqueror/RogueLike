...
public class ScrapSwordComponent extends SystemTest {
  public ScrapSwordComponent() {
    super(ScrapSwordComponent.class, false);
  }
  ...
  public void run() throws TimeoutException {
    init();
    // pick up sword component
    sendPickUp(Direction.SOUTH_EAST);
    assertUpdateWorld("{\"position\":{\"x\":5,\"y\":-21,\"z\":16},\"representation\":.}");
    assertNextCycle(1);
    assertActNow();
    // scrap the sopra component
    sendScrap(1);
    //this should result in game over
    assertGameEnd(false);
  }
}
