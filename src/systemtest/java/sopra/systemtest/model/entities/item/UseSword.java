...
public class UseSword extends SystemTest {
  public UseSword() {
    super(UseSword.class, false);
  }
  ...
  public void run() throws TimeoutException {
    ...
    assertUpdatePlayer("{\"currentHealth\":10,\"weapon\":"
            + "{\"damage\":2,\"level\":2,\"name\":\"Laserknarre\","
            + "\"range\":2},\"armor\":{\"armor\":1,\"level\":1,"
            + "\"name\":\"Shield\"},\"luck\":1,"
            + "\"strength\":1,\"level\":1,\"skillPoints\":0,\"vitality\":1,"
            + "\"name\":\"Player\",\"maxHealth\":20,\"agility\":1,"
            + "\"experience\":0}");
    ...
    assertChoiceWindow("{\"listType\":\"items\",\"items\":["
            ...
            + "\"objectType\":\"armor\"},{\"weapon\":{\"damage\":1,\"level\":1,"
