...
public class BugLootBeetleshellSystemTest extends DefaultSystemTest {

  public BugLootBeetleshellSystemTest() {
    super(BugLootBeetleshellSystemTest.class, false);
  }
  ...
  protected void execute() throws TimeoutException {
    ...
    assertChoiceWindow("{\"listType\":\"items\",\"items\":["
            + "{\"material\":{\"stackSize\":1,\"type\":\"beetleshell\"},"
            + "\"objectType\":\"material\"},{\"objectType\":\"empty\"},"
