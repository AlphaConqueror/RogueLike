...
public class UpgradeWithoutSkillpointsNotUnderAttack extends SystemTest {
  public UpgradeWithoutSkillpointsNotUnderAttack() {
    super(UpgradeWithoutSkillpointsNotUnderAttack.class, false);
  }
  ...
  public String createWorld() {
    return loadResource(this.getClass(), "maps/itemTestMaps/NoMonsterNoItems.json");
  }
  ...
  public void run() throws TimeoutException {
    init();
    sendUpgrade(1);
    //no skillpunkt left and should be faild
    assertCommandFailed();
    assertNextCycle(1);
    assertActNow();
    sendLeave();
