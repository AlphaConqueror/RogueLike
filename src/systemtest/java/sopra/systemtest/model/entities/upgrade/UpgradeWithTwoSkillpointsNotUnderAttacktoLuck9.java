...
public class UpgradeWithTwoSkillpointsNotUnderAttacktoLuck9 extends SystemTest {
  public UpgradeWithTwoSkillpointsNotUnderAttacktoLuck9() {
    super(UpgradeWithTwoSkillpointsNotUnderAttacktoLuck9.class, false);
  }
  ...
  public void run() throws TimeoutException {
    init();
    sendUpgrade(4);
    //skillpunkt should not be used cuz Luck is max = 9 now
    assertCommandFailed();
    assertNextCycle(1);
    assertActNow();
    sendLeave();
