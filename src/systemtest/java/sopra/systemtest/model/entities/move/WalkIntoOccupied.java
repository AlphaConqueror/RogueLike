...
public class WalkIntoOccupied extends SystemTest {
  public WalkIntoOccupied() {
    super(WalkIntoOccupied.class, false);
  }
  ...
  public String createWorld() {
    return loadResource(this.getClass(), "maps/itemTestMaps/PlayerSurroundedByItems.json");
  }
  ...
  public void run() throws TimeoutException {
    ...
    //assertCommandFailed(); // commented out due to recent test results
    assertNextCycle(1);
    assertActNow();
    sendLeave();
    assertGameEnd(false);
