...
public class RangedAttackTest extends SystemTest {

  public RangedAttackTest() {
    super(RangedAttackTest.class, false);
  }
  ...
  public String createWorld() {
    return loadResource(this.getClass(), "maps/Enemy2fieldsAhead.json");
  }
  ...
  public void run() throws TimeoutException {
    ...
    // monster should still have 6 HP so it should move in update Map
    assertEvent();
    assertEvent();
    assertNextCycle(1);
    assertActNow();
  ...
  protected void init() throws TimeoutException {
    ...
    assertUpdateWorld("{\"position\":{\"x\":7,\"y\":-22,\"z\":15},\"representation\":å}");
