...
public class ProfessorAttackedTest extends SystemTest {

  public ProfessorAttackedTest() {
    super(ProfessorAttackedTest.class, false);
  }
  ...
  public String createWorld() {
    return loadResource(this.getClass(),
            "maps/fightMaps/ProfessorAttacked.json");
  }
